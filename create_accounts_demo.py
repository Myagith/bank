...
def create_demo_accounts():
    ...
    # Créer des comptes de démonstration avec des numéros de 24 caractères max
    account_types = ['CHECKING', 'SAVINGS']
    account_numbers = [
        'FR1234567890123456789012',  # 24 caractères
        'FR2345678901234567890123',
        'FR3456789012345678901234',
        'FR4567890123456789012345',
        'FR5678901234567890123456',
        'FR6789012345678901234567',
        'FR7890123456789012345678',
        'FR8901234567890123456789',
        'FR9012345678901234567890',
        'FR0123456789012345678901',
        'FR1111111111111111111111',
        'FR2222222222222222222222',
        'FR3333333333333333333333',
        'FR4444444444444444444444',
        'FR5555555555555555555555',
        'FR6666666666666666666666',
        'FR7777777777777777777777',
        'FR8888888888888888888888',
        'FR9999999999999999999999',
    ...
    for i in range(4, len(customers)):
        account, created = Account.objects.get_or_create(
            number=f"FR{i:06d}000000000000000000"[:24],  # Limiter à 24 caractères
            defaults={
